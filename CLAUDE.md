...
`docs/index.md` を更新する際は `specs/004-sdd-slide-content/spec.md` の仕様も確認し、必要があれば同時に更新すること。
...
- N/A（Markdownルール文書の更新） + sphinx-oceanid（sphinxcontrib-mermaidから移行） (003-myst-notation-rules)
- MyST Markdown（myst-parser 5.0+） + Sphinx 9.1+, sphinx-revealjs 3.2+, sphinx-oceanid (004-sdd-slide-content)
